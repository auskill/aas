...
% (periodic execution: in a for loop, while loop, timers, callbacks, ..use your way)
    ...
    if((rI1.n > 0) && (rLa.n > 0) && (rS.n > 0))
        [x, landmarks] = ProcessAllData(rI1,rLa,rS,x, startFlag, landmarks);
